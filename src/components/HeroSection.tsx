...
import { ArrowRight, Sparkles, AlertCircle, Zap, Users, Target, Rocket } from "lucide-react";
  ...
  return (
    <section id="hero" className="min-h-[22vh] md:min-h-[26vh] pt-20 pb-16 md:pb-20 bg-[#0B0B10] relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Why Choose NUV - Replacing Problem/Solution */}
        <motion.div
        ...
        >
          ...
          <div className="grid grid-cols-3 gap-4 md:gap-8 max-w-4xl mx-auto">
            ...
            >
              <div className="flex items-center justify-center w-14 h-14 md:w-16 md:h-16 bg-[#FF3131]/20 rounded-xl md:rounded-2xl mb-3 md:mb-4 mx-auto">
                <Users className="h-7 w-7 md:h-8 md:w-8 text-[#FF3131]" />
              </div>
            ...
            >
              <div className="flex items-center justify-center w-14 h-14 md:w-16 md:h-16 bg-[#FF3131]/20 rounded-xl md:rounded-2xl mb-3 md:mb-4 mx-auto">
                <Target className="h-7 w-7 md:h-8 md:w-8 text-[#FF3131]" />
              </div>
              <div className="text-2xl md:text-3xl lg:text-4xl font-bold text-white">4.9/5</div>
              <div className="text-sm md:text-base text-gray-400 mt-1">Satisfaction</div>
            </motion.div>
            ...
            >
              <div className="flex items-center justify-center w-14 h-14 md:w-16 md:h-16 bg-[#FF3131]/20 rounded-xl md:rounded-2xl mb-3 md:mb-4 mx-auto">
                <Rocket className="h-7 w-7 md:h-8 md:w-8 text-[#FF3131]" />
              </div>
              <div className="text-2xl md:text-3xl lg:text-4xl font-bold text-white">2x</div>
              <div className="text-sm md:text-base text-gray-400 mt-1">Growth Avg</div>
            </motion.div>
          </div>
        </motion.div>
      </div>
